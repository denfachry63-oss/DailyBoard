...
judulKutipan.textContent = "Motivasi Hari Ini";
judulKutipan.style.margin = "0";

const tombolRefreshKutipan = document.createElement("button");
tombolRefreshKutipan.innerHTML = "↻ Refresh";
tombolRefreshKutipan.id = "btn-refresh-kutipan";

headerKutipan.appendChild(judulKutipan);
headerKutipan.appendChild(tombolRefreshKutipan);
sectionKutipan.appendChild(headerKutipan);

const pKutipan = document.createElement("p");
pKutipan.id = "kutipan-harian";
pKutipan.textContent = "Memuat kutipan...";
pKutipan.style.marginTop = "15px";
sectionKutipan.appendChild(pKutipan);

dashboardGrid.appendChild(sectionKutipan);

async function ambilKutipan() {
    const elKutipan = document.getElementById("kutipan-harian");
    elKutipan.style.color = "";
    elKutipan.textContent = "Memuat kutipan...";
    
    tombolRefreshKutipan.disabled = true;
    tombolRefreshKutipan.style.opacity = "0.6";
    ...
    try {
        ...
        tombolRefreshKutipan.disabled = false;
        tombolRefreshKutipan.style.opacity = "1";
    }
}

tombolRefreshKutipan.addEventListener("click", ambilKutipan);

const sectionCuaca = document.createElement("section");
sectionCuaca.innerHTML = "<h3>Cuaca</h3>";
dashboardGrid.appendChild(sectionCuaca);
...
dashboardGrid.appendChild(sectionTugas);
...
dashboardGrid.appendChild(sectionCatatan);
